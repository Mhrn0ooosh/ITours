...
{
    public abstract class SolutionsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SolutionsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SolutionsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SolutionsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SolutionsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SolutionsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SolutionsDbContext, Task<T>> func)
        {
            T result;
