...
namespace ITours.Solutions.Migrations
{
    ...
    [Migration("20200830134543_add2entities")]
    partial class add2entities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITours.Solutions.StudentCourses.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ITours.Solutions.StudentCourses.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ITours.Solutions.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ITours.Solutions.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ITours.Solutions.StudentCourses.Course", b =>
                {
                    b.HasOne("ITours.Solutions.StudentCourses.Student", "Student")
                        .WithMany()
